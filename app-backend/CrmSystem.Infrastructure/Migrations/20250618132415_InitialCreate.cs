        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RelatedCampaignId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tasks_Campaigns_RelatedCampaignId",
                        column: x => x.RelatedCampaignId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tasks_RelatedCampaignId",
                table: "Tasks",
                column: "RelatedCampaignId");
